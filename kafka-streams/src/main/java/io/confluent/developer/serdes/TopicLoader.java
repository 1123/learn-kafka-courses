    ...
    public static void main(String[] args) throws IOException {
     ...
     public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            final String inputTopic = prefixedTopicName(properties.getProperty("serdes.input.topic"));;
            final String outputTopic = prefixedTopicName(properties.getProperty("serdes.output.topic"));;
